...
function drawline(window_1, window_2)
{
  ...
  try
  {
    ...
    var v1 = graph.insertVertex(parent, null, '',  window_1_midpoint_x, window_1_midpoint_y, 0, 0);
    var v2 = graph.insertVertex(parent, null, '',window_2_midpoint_x, window_2_midpoint_y, 0, 0);
    var e1 = graph.insertEdge(parent, edge_id, '', v1, v2);
  }
  finally
  {
